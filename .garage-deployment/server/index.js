...
function getDraftSecret() {
	return "92dd5aac-0e47-4a16-89a1-8a0acb397206";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e3a99957-0b94-4709-9b6b-1d3cbb557ce0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e3a99957-0b94-4709-9b6b-1d3cbb557ce0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e3a99957-0b94-4709-9b6b-1d3cbb557ce0",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	...
	icons: {
		icon: [{
			url: "/garage/the-garage-favicon.png",
			type: "image/png",
			sizes: "500x500"
		}],
		apple: [{
