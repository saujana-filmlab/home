globalThis.__VINEXT_LAZY_CHUNKS__ = ["garage/assets/layout-segment-context-Cvcx60hy.js","garage/assets/garage-app-BsbIPC-T.js"];
...
function getDraftSecret() {
	return "1e04545c-ab41-4575-bc78-b14fec8620df";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "377b0d1d-15a5-4101-bd67-d2e76dce7b5a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "377b0d1d-15a5-4101-bd67-d2e76dce7b5a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "377b0d1d-15a5-4101-bd67-d2e76dce7b5a",
		rootBoundaryId
	});
}
/**
