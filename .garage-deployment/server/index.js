globalThis.__VINEXT_LAZY_CHUNKS__ = ["garage/assets/layout-segment-context-4I5Y92ac.js","garage/assets/garage-app-B08cIhk-.js"];
...
function getDraftSecret() {
	return "26c272e2-ec1b-46ca-8ee8-790b4d52f4e1";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "86985788-348b-42e6-b005-fe6c4db137d3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "86985788-348b-42e6-b005-fe6c4db137d3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "86985788-348b-42e6-b005-fe6c4db137d3",
		rootBoundaryId
	});
}
/**
