globalThis.__VINEXT_LAZY_CHUNKS__ = ["garage/assets/layout-segment-context-VgThvYev.js","garage/assets/garage-app-CqZi9enl.js"];
...
function getDraftSecret() {
	return "444274d3-b048-464b-a7ca-df415f9910a7";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "22a61a9c-054e-41db-bf8c-621fa399b3dc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "22a61a9c-054e-41db-bf8c-621fa399b3dc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "22a61a9c-054e-41db-bf8c-621fa399b3dc",
		rootBoundaryId
	});
}
/**
